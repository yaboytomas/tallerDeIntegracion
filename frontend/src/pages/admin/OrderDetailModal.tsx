...
export function OrderDetailModal({ orderId, onClose, onStatusUpdated }: OrderDetailModalProps) {
            ...
            <div className="flex flex-wrap items-end gap-4">
              <div className="flex-1 min-w-[200px]">
                ...
                <select
                  ...
                  className="w-full rounded-xl border-2 border-purple-300 px-4 py-3 font-semibold transition-all focus:border-purple-500 focus:ring-2 focus:ring-purple-200 focus:outline-none"
                >
              ...
              <button
                ...
                className="rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 font-bold text-white shadow-lg transition-all hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105"
              >
            ...
            <div className="rounded-2xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50 p-6 shadow-lg">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-neutral-900">{order.userId.email}</p>
                </div>
                {order.userId.phone && (
                  <div>
                    <p className="text-sm font-medium text-neutral-600">Teléfono</p>
                    <p className="text-lg font-bold text-neutral-900">{order.userId.phone}</p>
                  </div>
                )}
              </div>
            </div>
